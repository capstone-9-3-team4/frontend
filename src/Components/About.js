        ...
        <div className="md:px-4 md:grid md:grid-cols-2 lg:grid-cols-3 gap-5 space-y-4 md:space-y-0">
          <div className="max-w-sm bg-white px-6 pt-6 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500">
            ...
            <div className="relative">
              <img className="w-full rounded-3xl shadow-md shadow-dark-blue" src={Elizabeth} alt="Elizabeth" />
            </div>
          ...
          <div className="max-w-sm bg-white px-6 pt-6 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500">
            <div className="relative">
              <img className="w-full rounded-3xl shadow-md shadow-dark-blue" src={Ryan} alt="Ryan" /></div>
            <div className="flex space-x-5 items-baseline">
          ...
          <div className="max-w-sm bg-white px-6 pt-6 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500">
            ...
            <div className="relative">
              <img className="w-full rounded-3xl shadow-md shadow-dark-blue" src={Florance} alt="Florance" />
          ...
          <div className="max-w-sm bg-white px-6 pt-6 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500">
            ...
            <div className="relative">
              <img className="w-full rounded-3xl shadow-md shadow-dark-blue" src={Chris} alt="Chris" /> </div>
            <div className="flex space-x-5 items-baseline">
          ...
          <div className="max-w-sm bg-white px-6 pt-6 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500">
            ...
            <div className="relative">
              <img className="w-full rounded-3xl shadow-md shadow-dark-blue" src={Wilton} alt="Wilton" /> </div>
            <div className="flex space-x-5 items-baseline">
