...
export default function PatientJournalCardsLR () {
    ...
    return (
        <div className="font-sans">
            <div className="m-8 p-10 container mx-auto h-full border-8 border-green-500 bg-box-background rounded-2xl black justify-left items-center">
                <h1 className="font-bold text-3xl text-dark-purple ">Patients with Low Risk Entries </h1>
